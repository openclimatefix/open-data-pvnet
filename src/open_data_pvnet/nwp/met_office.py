...
CONFIG_PATHS = {
    "uk": PROJECT_BASE / "src/open_data_pvnet/uk_gfs_configs/met_office_uk_data_config.yaml",
    "global": PROJECT_BASE / "src/open_data_pvnet/uk_gfs_configs/met_office_global_data_config.yaml",
}
